...
class Feed_Forward:
    ...
    def __init__(input_size, output_size, hidden_size=100,
        ...
        self.biases_3 = np.zeors((output_size, 1))
        self.loss = loss
        self.activation = activation


    def make_prediction(feature_vec):
        '''
        ...
        layer_2 = self.actvation(dot_2 + self.biases_2)
        dot_3 = np.dot(self.weights_3, layer_2)
        out = self.activation(dot_3 + self.biases_3)
        return softmax(out, self.output_size)
